...
interface CannabisNextTest02Interface extends ethers.utils.Interface {
  functions: {
...
export class CannabisNextTest02 extends BaseContract {
  ...
  interface: CannabisNextTest02Interface;
