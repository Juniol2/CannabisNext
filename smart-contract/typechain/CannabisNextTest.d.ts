...
interface CannabisNextTestInterface extends ethers.utils.Interface {
  functions: {
...
export class CannabisNextTest extends BaseContract {
  ...
  interface: CannabisNextTestInterface;
