...
interface CannabisNextTest01Interface extends ethers.utils.Interface {
  functions: {
...
export class CannabisNextTest01 extends BaseContract {
  ...
  interface: CannabisNextTest01Interface;
